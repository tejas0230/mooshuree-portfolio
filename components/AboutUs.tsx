    ...
    return(
        <div className="w-full lg:max-w-[1440px] mx-auto flex flex-col items-center p-4" id="about-us">
            <div className="flex flex-row items-center justify-between w-full  border-y-3 border-primary p-4">
                <h1 className="text-[72px] md:text-[48px] font-heading text-center text-primary">ABOUT US</h1>
            </div>
            <div className="flex justify-center items-center w-full mt-4 flex-row  ">
                <div className="w-[50%] text-primary text-[32px] md:text-[20px] font-body text-left mt-4 px-20">
                    <p>
                    ...
                    <a href="mailto:mooshuree@gmail.com" className="text-white bg-primary  rounded-4xl px-6 py-4 inline-flex font-body text-[32px] md:text-[20px] mt-4 block">MOOSHUREE@GMAIL.COM</a>
                </div>
